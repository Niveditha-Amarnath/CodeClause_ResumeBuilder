...
class Resume extends JFrame implements ActionListener {
    ...
    // panel
    JFrame p=new JFrame("Resume Builder");
    JComboBox cb;
    // constructor
    Resume()
    {
        super("Resume Builder");
        p.getContentPane().setBackground(new java.awt.Color(207,154,252));
        // p.setBackground(Color.yellow);
        // create textfield
        String[] optionsToChoose = {"Male", "Female","Other"};
        ...
        JLabel fathernameJLabel= new JLabel("Father_Name:");
        JLabel passwordJLabel= new JLabel("Password:");
        JLabel cpasswordJLabel= new JLabel("Confirm_Password:");
        ...
        JLabel collegeJLabel= new JLabel("University:");
        JLabel degreeJLabel= new JLabel("Degree:");
        JLabel linkedlnJLabel= new JLabel("Linkedin_Profile_Link:");
        JLabel githubJLabel= new JLabel("Github_Profile_Link:");
        JLabel hackerJLabel= new JLabel("HackerRank_Profile_Link:");
        JLabel contactJLabel= new JLabel("Contact_Number:");
